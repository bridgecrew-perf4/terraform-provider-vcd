...
[go-vcloud-director coding guidelines](https://github.com/lmicke/go-vcloud-director/blob/master/CODING_GUIDELINES.md))
...
[TESTING.md](https://github.com/lmicke/terraform-provider-vcd/blob/master/TESTING.md)
for more info.
